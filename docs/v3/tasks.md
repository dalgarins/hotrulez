...
Status: **archived — 0.7 complete.** This is the 0.7 (Actionable Diagnostics)
...
record for the 0.7 phase. The 0.8 (Authoring Polish) breakdown lives in the
active `docs/tasks.md`; 0.9 remains a roadmap sketch.
Last updated: 2026-07-02 (archived 2026-07-03).
Source: `docs/v3/spec.md` (archived).
